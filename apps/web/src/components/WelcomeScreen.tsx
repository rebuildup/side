    ...
    <div className="welcome-screen">
      ...
      <div className="welcome-steps">
        <StepCard
          number={1}
          title="Add Workspace"
          description="Select a folder containing your project"
          iconName="folder"
          actionButton="Add Workspace"
          onAction={onOpenWorkspaceModal}
          completed={hasWorkspace || hasDeck}
        />

        <StepCard
          number={2}
          title="Create Deck"
          description="Decks organize your terminals by project"
          iconName="grid"
          actionButton="Create Deck"
          onAction={onOpenDeckModal}
        ...
        <StepCard
          number={3}
          title="Add Terminals"
          description="Use + button or shortcuts (C/X) for Claude/Codex"
          iconName="terminal"
          disabled={!hasDeck}
          completed={false}
        />
...
function StepCard({
  ...
  return (
    <div className={`step-card ${completed ? "completed" : ""} ${disabled ? "disabled" : ""}`}>
      <div className="step-card-header">
        ...
        {iconName === "folder" && (
          <Folder size={24} className="step-card-icon" opacity={completed ? 1 : 0.3} />
        )}
        {iconName === "grid" && (
          <div className="step-card-icon" style={{ opacity: completed ? 1 : 0.3 }}>
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
      ...
      {actionButton && onAction && !completed && (
