...
export function GlobalStatusBar({ serverStatus, activeTerminalsCount = 0, contextHealthScore = 100, onToggleContextStatus, }) {
    ...
    return (<div className="global-status-bar">
      <div className="global-statusbar-left">
        {serverStatus || (<span className="statusbar-item">
            <span className="status-indicator status-online"></span>
            Server: Connected
          </span>)}
        {onToggleContextStatus && (<button className="statusbar-item statusbar-clickable" onClick={onToggleContextStatus} title="View context manager status" style={{
                border: "none",
                background: "none",
                cursor: "pointer",
                display: "flex",
