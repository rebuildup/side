...
class ContextManager {
  ...
  constructor(options = {}) {
    ...
    this.controller = new context_controller_1.ContextController(
      this.store,
      this.monitor,
      this.analyzer
    );
...
Object.defineProperty(exports, "SessionStore", {
  enumerable: true,
  get: () => session_store_2.SessionStore,
});
// Core
var session_monitor_2 = require("./core/session-monitor");
Object.defineProperty(exports, "SessionMonitor", {
  enumerable: true,
  get: () => session_monitor_2.SessionMonitor,
});
var session_analyzer_2 = require("./core/session-analyzer");
Object.defineProperty(exports, "SessionAnalyzer", {
  enumerable: true,
  get: () => session_analyzer_2.SessionAnalyzer,
});
var context_controller_2 = require("./core/context-controller");
Object.defineProperty(exports, "ContextController", {
  enumerable: true,
  get: () => context_controller_2.ContextController,
});
var snapshot_manager_2 = require("./core/snapshot-manager");
Object.defineProperty(exports, "SnapshotManager", {
  enumerable: true,
  get: () => snapshot_manager_2.SnapshotManager,
});
var output_trimmer_2 = require("./core/output-trimmer");
Object.defineProperty(exports, "OutputTrimmer", {
  enumerable: true,
  get: () => output_trimmer_2.OutputTrimmer,
});
var session_compactor_2 = require("./core/session-compactor");
Object.defineProperty(exports, "SessionCompactor", {
  enumerable: true,
  get: () => session_compactor_2.SessionCompactor,
});
// Detectors
var topic_drift_2 = require("./detectors/topic-drift");
Object.defineProperty(exports, "TopicDriftDetector", {
  enumerable: true,
  get: () => topic_drift_2.TopicDriftDetector,
});
